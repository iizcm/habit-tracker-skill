...
| Field | Value |
| --- | --- |
| **Name** | `habit-tracker-skill` |
| **Description** | AI agent skill: habit-tracker |
| **Category** | general |
| **Version** | `0.1.0` |
| **Author** | Community |
| **License** | MIT |
...
cp -r habit-tracker ~/.hermes/skills/habit-tracker/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/habit-tracker-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/habit-tracker-skill.git ~/.hermes/skills/habit-tracker/
```
...
```text
Use the habit tracker skill to <describe your specific task here>
```
...
```text
Gunakan skill habit tracker untuk <deskripsikan tugas spesifik Anda di sini>
```
